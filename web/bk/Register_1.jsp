        ...
        <div id="wrapper">
            ...
            <form action="Register" method="Post" id="form-login">
                ...
                <div class="regGG-button">
                    <div>
                        <a class="button" href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8080/HutzFood/RegGoogle&response_type=code&client_id=278095835882-p45gk2r34laln8itkv6csj2rm7oa0ssc.apps.googleusercontent.com&approval_prompt=force">
