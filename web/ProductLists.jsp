        ...
        <div class="container">
            ...
            <ul class="filters_menu">
                ...
                <c:forEach items="${requestScope.clist}" var="i" varStatus="idx">
                    <li data-filter=".filter-${i.getId()}">${i.getName()}</li>
                </c:forEach>
            </ul>
            ...
            <div class="filters-content">
                <div class="row grid">
                    <c:forEach var="p" items="${plist}">
                        <div class="col-sm-6 col-lg-4 all filter-${p.getCategory().getId()}">
                            <div class="box">
                                <div>
                                    <div class="img-box">
            ...
            <div class="d-flex justify-content-center mt-4">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <li class="page-item">
                            <a class="page-link" href="ProductLists?index=1&categoryId=${param['categoryId']}" aria-label="Previous">
                        ...
                        <c:forEach var = "i" begin = "1" end = "${numberPage}">
                            <li class="${param['index']==i?'page-item active':'page-item'}">
                                <a class="page-link" href="ProductLists?index=${i}&categoryId=${param['categoryId']}"><span>${i}</span></a>
                            </li>
                        </c:forEach>
                        <li class="page-item">
                            <a class="page-link" href="ProductLists?index=${numberPage}&categoryId=${param['categoryId']}" aria-label="Next">
