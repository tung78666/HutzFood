        ...
        <section class="slider_section ">
            <div id="customCarousel1" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <c:forEach varStatus="status" var="b" items="${recentBlogs}">
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <div class="btn-box">
                                            <a href="BlogController?blogId=${b.getBlog_id()}" class="btn1">
                                                View
                                            </a>
                                        </div>
                                    </div>
    ...
    <section class="food_section layout_padding-bottom">
        <div class="container">
            <div class="heading_container heading_center">
                ...
                <p>Here, we would like to introduce you to the best-selling products, bringing you great and memorable
